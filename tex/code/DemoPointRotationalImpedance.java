 ...
 * @see #dispose()
 */
public class DemoPointRotationalImpedance extends RoboticsAPIApplication {
	...
	public static void main(String[] args) {
		DemoPointRotationalImpedance app = new DemoPointRotationalImpedance();
		app.runApplication();
	}
}
